var dbProperties = {
    database: 'portfolio', // название базы данных
...
db.direction = require('../model/direction.model.js')(sequelize, Sequelize);
db.faculty = require('../model/faculty.model.js')(sequelize, Sequelize);
